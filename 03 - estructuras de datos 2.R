...
FG <- read.csv2("C:/Users/Juan Camilo/Dropbox/UE/Data Wrangling en R/codigo/FG2000_2017.csv")
...
text(bp, 0, round(100*tabla.top5.rel, 1), cex = 2, pos = 3, col = "red", font = 3) 
...
# coeficiente de variacion 
apply(X = FG.cuanti, MARGIN = 2, FUN = function(cami) 100 * sd(cami)/mean(cami))
...
windows()
boxplot(FG.cuanti.sura, horizontal = TRUE, boxwex = 0.5, ylim=c(0,100), cex = 0.8, las = 1,
